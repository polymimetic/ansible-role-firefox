...
# https://github.com/polymimetic/ansible-role-firefox
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/ansible-role-firefox/master/install.sh | bash
#
###########################################################################
...
readonly GIT_REPO="https://github.com/polymimetic/ansible-role-firefox.git"
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/ansible-role-firefox/master"
...
install_firefox() {
  ...
  local firefox_files="${SCRIPT_PATH}/files/firefox"
  ...
  sudo apt-get install -yq "${firefox_deps[@]}"
